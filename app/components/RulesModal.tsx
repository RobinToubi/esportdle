            ...
            >
                <Box sx={style}>
                    <h1 style={{ textAlign: 'center' }}>
                        How to play LOLESPORTDLE
                    </h1>
                    <h3>Principles</h3>
                    <p>
                        Each day*, you have seven tries to find the daily
                        player**. For each try, the game gives you hints to help
                        you.
                    </p>
                    ...
                    <p>
                        For each player&apos;s selection, you will see a line on
                        the table representing how close you are from the
                        result. If you hover a table cell, you&apos;ll have some
                        informations about your result.
                    </p>
                    <section
                        style={{
                            display: 'flex',
                    ...
                    <p style={{ fontStyle: 'italic' }}>
                        ...
                        **The playerbase includes only major league players
                        (LEC, LCK, LCS, LPL).
                    </p>
                    <Box
                        sx={{
